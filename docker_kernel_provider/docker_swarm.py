...
class DockerSwarmKernelLifecycleManager(ContainerKernelLifecycleManager):
    """Kernel lifecycle management for kernels in Docker Swarm."""
    def __init__(self, kernel_manager, lifecycle_config):
        super(DockerSwarmKernelLifecycleManager, self).__init__(kernel_manager, lifecycle_config)
    ...
    def launch_process(self, kernel_cmd, **kwargs):
        ...
        return super(DockerSwarmKernelLifecycleManager, self).launch_process(kernel_cmd, **kwargs)
...
class DockerKernelLifecycleManager(ContainerKernelLifecycleManager):
    """Kernel lifecycle management for Docker kernels (non-Swarm)."""
    def __init__(self, kernel_manager, lifecycle_config):
        super(DockerKernelLifecycleManager, self).__init__(kernel_manager, lifecycle_config)
    ...
    def launch_process(self, kernel_cmd, **kwargs):
        ...
        return super(DockerKernelLifecycleManager, self).launch_process(kernel_cmd, **kwargs)
